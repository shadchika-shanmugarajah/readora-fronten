...
export default function FloatingWhatsAppWidget() {
  ...
  return (
    ...
    >
      {/* Tooltip Label */}
      <div className={`px-4 py-2 rounded-xl bg-slate-900/90 text-white text-xs font-semibold border border-white/5 backdrop-blur-md shadow-lg transition-all duration-300 transform origin-right ${
      ...
      <button
        onClick={handleClick}
        className="relative flex items-center justify-center w-14 h-14 rounded-full bg-emerald-500 text-white shadow-2d-glow hover:shadow-2d-glow-hover hover:scale-110 active:scale-95 transition-all duration-300"
