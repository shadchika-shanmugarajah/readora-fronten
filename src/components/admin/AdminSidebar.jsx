...
export default function AdminSidebar({ collapsed }) {
  ...
  const menuItems = [
    ...
    { name: 'Authors', path: '/admin/dashboard/authors', icon: Users, roles: ['super_admin', 'admin', 'staff'] },
    { name: 'Publishers', path: '/admin/dashboard/publishers', icon: Layers, roles: ['super_admin', 'admin', 'staff'] },
